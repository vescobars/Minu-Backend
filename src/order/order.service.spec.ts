...
describe('OrderService', () => {
 ...
 //TODO: Create the other objects and replace the nulls
...
//TODO: Replace the nulls with actual objects
it('create should return a new order', async () => {
  ...
  expect(storedOrder.orderDetail).toEqual(newOrder.orderDetail)
  expect(storedOrder.payMode).toEqual(newOrder.payMode)
  expect(storedOrder.table).toEqual(newOrder.table)
  expect(storedOrder.client).toEqual(newOrder.client)
  expect(storedOrder.restaurantSite).toEqual(newOrder.restaurantSite)
});
